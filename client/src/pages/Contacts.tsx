  ...
  return (
    <div className="contacts container">
      <div className="contacts__top">
        <div
          className="contacts__top-map"
          style={{ width: "50%", height: "300px", backgroundColor: "green" }}
        ></div>
        <div className="contacts__top-detail">
          <p className="contacts__top-detail-adress">
            "ХОББИ ХОЛЛ" г. Киров, Октябрьский пр-т, 74
          </p>
          ...
          <p className="contacts__top-detail-tel">
            8(8332) 01-01-01, 8-912-01-01-01
          </p>
          <p className="contacts__top-detail-text">
            {" "}
      ...
      <p className="contacts__text">
        Интернет-магазин работает на прием заказов круглосуточно.
      </p>
