...
const BasketDelivery = <TFormValues extends FieldValues> ({register}: FormProps<TFormValues>) => {
    ...
    return (
        <div className='basket__delivery'>
            ...
            <MySelect register={register} onChange={changeActiveDelivery}  data={deliveryArr}></MySelect>
