...
const Header = memo(() => {
  const isAuthorizated = useSelector(
    (state: RootState) => state.authSlice.isAuthorizated
  );
  const basketCount = useSelector(
    (state: RootState) => state.basketSlice.basketCount
  );
      ...
      <div className="header__wrapper container">
        ...
        <div className="header__right">
          <div className="header__top">
            {isAuthorizated && (
              <Link className="header__top-links" to="/profile">
                Профиль
              </Link>
            )}
            <Link className="header__top-links" to="/rules">
              Правила
            </Link>
            <Link className="header__top-links" to="/contacts">
              Контакты
            </Link>
          </div>
          <div className="header__rigth-middle">
            {isAuthorizated ? (
              <div
                className="header__rigth-middle-login"
                onClick={() => dispatch(logout())}
              >
                <img
                  className="header__rigth-middle-login-img"
                  src={login}
                  alt="login"
                ></img>
            ...
            <Link to="/basket">
              <div className="header__rigth-middle-basket-wrapper">
                <img
                  className="header__rigth-middle-basket-img"
                  src={basket}
                  alt="Basket"
                ></img>
                <div className="header__rigth-middle-counter">
                  {basketCount}
                </div>
              </div>
